...
<head>
    ...
    <link rel="stylesheet" href="/challenge/3/screen.css">
    <link rel="stylesheet" type="text/css" href="/challenge/3-AdminPanel/style.css">
    <!--  <a href = "/Challenges/3-AdminPanel/source.txt>A tiny hint hihi</a>-->
    <title>Honeypot 16</title>
</head>
<body>
<form class="box" action="/challenge/3-AdminPanel/flag.php" method="get">
